...
");
			...
			Assert.IsTrue(samlresp.IsValid("http://sp.example.com/demo1/metadata.php"));
			Assert.IsFalse(samlresp.IsValid("http://sp.example.com/another-app/metadata.php"));
			Assert.IsFalse(samlresp.IsValid(""));
...
-----END CERTIFICATE-----";
			...
			Assert.IsTrue(samlresp.IsValid("WebApp3"));
...
-----END CERTIFICATE-----";
			...
			var request = new Saml.IdpLogoutRequest(cert);
			request.LoadXml(logoutRequestXml);

			Assert.IsTrue(request.IsValid());
			Assert.AreEqual("egon@got.com@is.com", request.GetNameID());
			Assert.AreEqual("8c8354d5-4eea-4942-8651-ce12fa4626ea", request.GetSessionIndex());
		}
	}
}
